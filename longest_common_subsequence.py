...
class Solution:
    def longestCommonSubsequence(self, text1: str, text2: str) -> int:
        ...
        @lru_cache(
            maxsize=None)  # This memoize the function calls
        # with arguments and returned results so that you can call again later on
        # with same parameters without incurring additional computation.
